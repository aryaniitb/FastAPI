...
def load_agent():
    ...
    try:
        ...
        ChatOpenAI(
        model="llama3:latest",
        openai_api_base="https://1632-34-19-119-51.ngrok-free.app/v1",
        openai_api_key="Not needed for local server"),  # Pass the model as a keyword argument
        "Housing.csv",
        verbose=True,
...
def load_model():
    ...
    try:
        llama2 = ChatOpenAI(
        model="llama3:latest",
        openai_api_base="https://4802-35-221-44-198.ngrok-free.app/v1",
